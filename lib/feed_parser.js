...
module.exports = function(app) {
	...
	function getFeeds() {
		...
		function callback1() {
			...
			setTimeout(persistInvertedIndex, 10000);
		}
	...
	function getInvertedIndex(finalArr, article) {
		...
		documentID++;
		// var output = '';
		// for (property in invertedIndex) {
		// output += property + ': ' + invertedIndex[property] + '; ';
		// }
		// console.log('---inverted index ---' + output);
